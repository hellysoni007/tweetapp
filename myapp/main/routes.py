...
from flask import flash, redirect, url_for, request, render_template, current_app, g
from flask_login import login_required, current_user

from myapp import db
from myapp.main import bp
from myapp.main.forms import PostForm, EmptyForm, EditProfileForm, SearchForm
...
def user(username):
    ...
    form = EmptyForm()
    return render_template('user.html', user=user, form=form, posts=posts, next_url=next_url, prev_url=prev_url, )
